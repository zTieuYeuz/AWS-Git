...
9. Tại trang **Attach to VPC**.
  + Tại mục **Available VPCs** chọn **ASG**.
  + Click **Attach internet gateway**.
  + Kiểm tra quá trình attach thành công như hình dưới.

![VPC](/images/2.prerequisite/010-createigw.png)

10. Tiếp theo chúng ta sẽ tạo một custom route table để gán vào **Public Subnet**.
  + Click **Route Tables**.
...
13. Tại trang **Edit routes**.
  ...
  + Tại mục **Target** chọn **Internet Gateway** sau đó chọn **Lab IGW** đã tạo trước đó
  + Click **Save changes**.
